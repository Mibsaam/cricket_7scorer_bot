...
def master_action_handler(c):
    ...
    try:
        ...
        if dt == "menu_merge_duplicate_profiles":
            ...
            return safe_edit_message("✍️ Do player profiles ko merge karne ke liye unke naam `OldName | NewName` format me type karke bhejein (jaise: `Adip | Adip Khan`):", chat_id=cid, message_id=mid)
