...
def master_action_handler(c):
    ...
    try:
        ...
        # STEP 7 OPENERS SELECTION HANDLERS
        ...
        if dt.startswith("wiz_bowl_"):
            ...
            match.update({
                ...
                "target": 0 if match["current_inning"] == 1 else match["target"], "match_status": "Active",
