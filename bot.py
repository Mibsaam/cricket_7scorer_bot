...
def master_action_handler(c):
    try:
        ...
        # VIEW ONLY BUTTONS (Public Access)
        if dt == "view_summary":
        ...
        # 1. TOTAL OVERS SETTING MENU (PRESET + MANUAL TYPE)
        ...
        # 3. RUN SCORING (DIRECTION PROMPT)
        ...
        # 4. WIDE MENU (CLEAN NO BAT LABEL)
        if dt == "menu_wide":
            m = InlineKeyboardMarkup(row_width=3)
            for r in range(7):
