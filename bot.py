...
def validate_on_field_players(cid):
    if match["match_status"] == "Innings Break":
        safe_send_message(cid, "🏁 **Innings 1 complete ho chuki hai!** Niche diye gaye button se 2nd Innings shuru karein:", reply_markup=get_scorer_keyboard(ADMIN_ID))
        return False
...
def handle_text_inputs(msg):
    ...
    try:
        ...
        # TYPED OPENERS CHAIN (AUTO CONTINUES TO NEXT STEP)
