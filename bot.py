...
# ================= CLEAN SCORECARD WITH ZERO WRAPPING =================
...
# ================= VALIDATE ACTIVE BATTER AND BOWLER BEFORE SCORING =================
        ...
        if act == "wiz_type_series_name":
            ...
            try:
                ...
                if match["current_inning"] == 2 and orig_ov > 0:
                    match["target"] = max(1, math.ceil(match["target"] * (rev_ov / orig_ov)))
            ...
            if match["runs"] == 0 and match["balls"] == 0:
                match.update({
                    "runs": 0, "wickets": 0, "overs": 0.0, "balls": 0,
                    "extras_total": 0, "extras_wides": 0, "extras_noballs": 0, "extras_byes": 0, "extras_legbyes": 0,
                    "target": 0, "current_inning": 1, "match_status": "Active",
